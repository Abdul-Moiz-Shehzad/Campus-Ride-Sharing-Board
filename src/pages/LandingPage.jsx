        ...
        <div className="landing-page">
            ...
            <div className="hero-section">
                <div className="hero-text">
                    ...
                    <p> CampusRide helps students easily share rides, request rides, and connect with others traveling the same route. </p>
            ...
            <div className="features-section">
                ...
                <div className="features-grid">
                    ...
                    <div className="feature-card">
                        <h3>Request Rides</h3>
                        <p>Need a ride? Post your request and drivers can respond to help you reach your destination.</p>
                    </div>

                    <div className="feature-card">
                        <h3>Book Seats</h3>
                        <p> Browse available rides and instantly book a seat with the driver. </p>
                    </div>
            ...
            <div className="cta-section">
                ...
                <p>Join other students using CampusRide to travel easilyaround campus.</p>
